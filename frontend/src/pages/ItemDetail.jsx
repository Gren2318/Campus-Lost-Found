...
import { MapPin, Calendar, ArrowLeft, Mail, User } from 'lucide-react';
      ...
      <div className="bg-slate-800 rounded-2xl overflow-hidden border border-slate-700 shadow-2xl flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 p-8 flex flex-col">
          <div className="flex justify-between items-start mb-4">
            <span className={`px-3 py-1 rounded-full text-sm font-bold ${item.category === 'Lost' ? 'bg-red-500/20 text-red-400' : 'bg-green-500/20 text-green-400'}`}>
              {item.category}
            </span>
          ...
          <div className="mt-auto pt-6 border-t border-slate-700">
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href={`mailto:${item.owner_id}?subject=Regarding your lost item: ${item.title}`}
